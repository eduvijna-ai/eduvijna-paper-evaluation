...
async def record_ai_execution(
    ...
    *,
    ...
    learning_plan_run_id: uuid.UUID | None = None,
    improvement_assessment_id: uuid.UUID | None = None,
    authoring_ai_run_id: uuid.UUID | None = None,
    ...
    row = AiExecutionRecord(
        ...
        learning_plan_run_id=learning_plan_run_id,
        improvement_assessment_id=improvement_assessment_id,
        authoring_ai_run_id=authoring_ai_run_id,
