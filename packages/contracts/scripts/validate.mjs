...
const requiredPaths = [
  ...
  "/api/v1/quality/answer-clusters/runs/{run_id}",
  "/api/v1/quality/answer-clusters/runs/{run_id}/clusters",
  "/api/v1/quality/answer-clusters/clusters/{cluster_id}",
  "/api/v1/quality/answer-clusters/clusters/{cluster_id}/reviews",
  "/api/v1/outcomes/definitions",
  "/api/v1/outcomes/definitions/{definition_id}",
  "/api/v1/outcomes/mapping-sets",
  "/api/v1/outcomes/mapping-sets/{mapping_set_id}",
  "/api/v1/outcomes/mapping-sets/{mapping_set_id}/mappings",
  "/api/v1/outcomes/mapping-sets/{mapping_set_id}/activate",
  "/api/v1/outcomes/mappings/{mapping_id}",
  "/api/v1/outcomes/attainment-reports",
  "/api/v1/outcomes/attainment-reports/{report_id}",
  "/api/v1/outcomes/attainment-reports/{report_id}/export.csv",
  ...
  "/api/v1/integrations/identity-providers/{provider_id}",
  "/api/v1/integrations/identity-providers/{provider_id}/scim-token",
  "/api/v1/integrations/lti-platforms",
  "/api/v1/integrations/lti-platforms/{platform_id}/tool-jwks",
  "/api/v1/integrations/roster-sync",
  "/api/v1/integrations/roster-sync/{run_id}",
